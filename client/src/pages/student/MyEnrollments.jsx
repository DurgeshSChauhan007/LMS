...
const MyEnrollments = () => {
  ...
  return (
    ...
    <div className='md:px-36 px-38 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden border border-gray-400 mt-10'>
          <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left ms-sm:hidden'>
            <tr>
