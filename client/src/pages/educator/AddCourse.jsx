  ...
  <img className='max-h-10' src={image ? URL.createObjectURL(image) : ''} alt="" />
          ...
          <div>
            { chapters.map((chapter, chapterIndex) => (
              <div key={chapterIndex} className='bg-hite border rounded-lg mb-4'>
                <div className='flex justify-between items-center p-4 border-b'>
                  <div className='flex items-center'>
                    <img onClick={() => handleChapter('toggle', chapter.chapterId)} src={assets.dropdown_icon} width={14} alt="" className={`mr-2 cursor-poiner transition-all ${chapter.collapsed && "-rotated-90"}`} />
                ...
                {!chapter.collapsed && (
                  ...
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>{lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target="_blank" className='text-blue-500'>Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}</span>
