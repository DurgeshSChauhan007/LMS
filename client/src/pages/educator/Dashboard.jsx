    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <div>
          ...
          <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border-gray-600/20'>
          <table className='table-fixed md:table-auto w-full overflow-hidden'>
            <thead className='text-gray-900 border-b border-gray-600/20 text-sm text-left'>
              <tr>
